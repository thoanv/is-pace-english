...
<div class="col small-12 large-6 postss">
    <div class="achievement-card">
        ...
        <div class="content-section" title="{{$post['title']}}">
            <a href="{{$route}}">
                <h2 class="title text-223f81">{{$post['title']}}</h2>
            </a>
            <div class="box-text" style="padding: 3px 0 10px;">
                <div class="news-date" style="margin-bottom: 0">
                    ...
                    <div class="news-date-item">
                        ...
                        <span>
                        {{date('d/m/Y', strtotime($post['date_publish']))}}
                        </span>
                    </div>
                    <div class="postview">
                        <i class="fa fa-eye"></i> {{$post['view']}} lượt xem
                    </div>
                </div>
            </div>
    ...
    margin-top: 4px;
    color: #223f81;
}">Xem thêm <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
        </div>
    </div>
</div>
